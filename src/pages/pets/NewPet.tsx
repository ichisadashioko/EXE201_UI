      ...
      <div>
        <button
          onClick={() => {
            ...
            let pet_name_input = document.getElementById(
              "input_pet_name"
            ) as HTMLInputElement;
            ...
            api_create_new_pet(access_token, pet_name).then((response) => {
              ...
              if (response.success) {
                try {
                  ...
                  console.error(
                    "problem getting pet id from response data:",
                    response
                  );
                  console.error(error);
                  // TODO use better alert for UX
                  alert(
                    "Pet created but problem getting pet id from response data, see console for details"
                  );
                }
              } else {

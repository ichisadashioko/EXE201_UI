...
const Profile = () => {
  ...
  const [user, setUser] = useState<api_get_user_profile_UserProfile>();
  ...
  return (
    <div className="w-full">
      <div className="w-full relative inline-block h-[220px] ">
        <img
      ...
      <div className="mt-[10vh] mb-3 text-center">
        <h3 className="text-2xl font-semibold">
          {/* TODO create function to get username */}
          {user && user.name ? user.name : `User #${user?.id}`}
        </h3>
      </div>
